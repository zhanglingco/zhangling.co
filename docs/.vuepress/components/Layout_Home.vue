...
.container
	...
	.links.animated.fadeInDown(style="animation-delay: .4s;")
		a(href="http://github.com/zhanglingco")
...
export default {
	data () {
		return {
			...
			// 菜单列表
			menus: [
				{ title: 'Articles', link: 'https://github.com/zhanglingco/Blog/issues'},
				{ title: 'Books', link: 'https://github.com/zhanglingco?tab=repositories&q=book'},
				{ title: 'Projects', link: 'https://github.com/zhanglingco?tab=repositories&q=project'},
				{ title: 'Code', link: 'https://github.com/zhanglingco'},
				{ title: 'About me', link: '/aboutme.html'},
			],
			// 推荐列表
			recommends: [
